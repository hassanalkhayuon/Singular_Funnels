function [gap] = homoclinic_gap(EPSS,alpha)
...
[t, var_m1] = ode15s(odefun,[tend 0],initcond_m,opts1);
initcond_m = [2*pi var_m1(end,2)];
[t, var_m2] = ode15s(odefun,[tend 0],initcond_m,opts2);
